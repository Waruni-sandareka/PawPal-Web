                    ...
                    <Col lg='8' className='m-auto'>
                        <div className="flex w-4/5 items-center mx-10">
                            ...
                            <div className='form bg-textYellowColor relative w-3/5 rounded-lg shadow-lg px-8 py-10 ml-5 flex flex-col items-center'>
                                ...
                                <p className='mt-3 font-light text-xs'>Are you already registered? <br></br> <Link to='/login' spy={true} smooth={true} duration={500} className='cursor-pointer text-textDarkBrown hover:underline'>Login</Link></p>
                            </div>
                        </div>
                    </Col>
                </Row>
